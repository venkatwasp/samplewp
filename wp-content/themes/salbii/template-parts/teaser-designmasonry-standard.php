<?php
/**
 * Standard blog teaser design
 *
 * The default template for displaying content teasers. Used for both single and index/archive/search.
 * this code used across the pages and blog post where the_content() used
 *
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('isotope-item post-format'); ?>>
		...
		<?php
			if ( has_post_thumbnail() ) {
				...
				echo '<div class="break-teaser-padding colored-card-part post-thumb no-featured-image">';

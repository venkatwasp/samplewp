...
if(!class_exists('Redux_Options') ){
    ...
    if(!defined('Redux_OPTIONS_URL')) {
    	if($fslashed_abs == "/") define('Redux_OPTIONS_URL', site_url($fslashed_dir));	// for Windows when ABSPATH = '//'
        else define('Redux_OPTIONS_URL', site_url(str_replace($fslashed_abs, '', $fslashed_dir)));
    }
        ...
        */
        function _options_page_html() {
            ...
            if(true === $this->args['show_import_export']) {
                ...
                echo '</textarea>';
                echo '<input type="text" class="large-text" id="redux-opts-export-link-value" value="' . esc_attr(add_query_arg(array('feed' => 'reduxopts-' . $this->args['opt_name'], 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url())) . '" />';
            ...
            // reset cache, regenerate css
            lbmn_customized_css_cache_reset();
        }
